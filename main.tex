...
\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|c|}
		...
		\cellcolor[HTML]{CCE5E5} \textbf{Val Box Loss} &
		\cellcolor[HTML]{CCE5E5} \textbf{Val Cls Loss} &
		\cellcolor[HTML]{CCE5E5} \textbf{Precision} &
		\cellcolor[HTML]{CCE5E5} \textbf{Recall} \\
		\hline
		\cellcolor[HTML]{FFE0CC} Yolov8n & \cellcolor[HTML]{E6F2E6} 0.75616 & \cellcolor[HTML]{E6F2E6} 0.3363 & \cellcolor[HTML]{E6F2E6} 1.90664 & \cellcolor[HTML]{E6F2E6} 1.20159 & \cellcolor[HTML]{E6F2E6} 0.77565 & \cellcolor[HTML]{FFE0CC} 0.69992 \\
		\hline
		\cellcolor[HTML]{FFE0CC} Yolov11n & \cellcolor[HTML]{E6F2E6} 0.75954 & \cellcolor[HTML]{E6F2E6} 0.3346 & \cellcolor[HTML]{E6F2E6} 1.92994 & \cellcolor[HTML]{E6F2E6} 1.21736 & \cellcolor[HTML]{E6F2E6} 0.77941 & \cellcolor[HTML]{FFE0CC} 0.69992 \\
		\hline
		\cellcolor[HTML]{FFE0CC} Yolov11m & \cellcolor[HTML]{E6F2E6} 0.76746 & \cellcolor[HTML]{E6F2E6} 0.3402 & \cellcolor[HTML]{E6F2E6} 1.93944 & \cellcolor[HTML]{E6F2E6} 1.22461 & \cellcolor[HTML]{E6F2E6} 0.78162 & \cellcolor[HTML]{FFE0CC} 0.69992 \\
		\hline
		\cellcolor[HTML]{FFE0CC} Detectron2 & \cellcolor[HTML]{E6F2E6} - & \cellcolor[HTML]{E6F2E6} - & \cellcolor[HTML]{E6F2E6} - & \cellcolor[HTML]{E6F2E6} - & \cellcolor[HTML]{E6F2E6} Accuracy: 0.9453 & \cellcolor[HTML]{FFE0CC} False Neg: 0.09526 \\
		\hline
	\end{tabular}
	\gr 
	\captionof{table}{\gr Συνοπτική Σύγκριση των Μοντέλων}
\end{center}
}
\paragraph{\textnormal{
...
\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
		...
		\cellcolor[HTML]{CCE5E5} \textbf{Precision} &
		\cellcolor[HTML]{CCE5E5} \textbf{Recall} &
		\cellcolor[HTML]{CCE5E5} \textbf{F1} &
		\cellcolor[HTML]{CCE5E5} \textbf{Accuracy} &
		\cellcolor[HTML]{CCE5E5} \textbf{False Neg} &
		\cellcolor[HTML]{CCE5E5} \textbf{False Pos} \\
		\hline
		\cellcolor[HTML]{FFE0CC} Yolov8n & \cellcolor[HTML]{E6F2E6} 0.75507 & \cellcolor[HTML]{E6F2E6} 0.33642 & \cellcolor[HTML]{E6F2E6} 0.77109 & \cellcolor[HTML]{E6F2E6} 0.68028 & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- \\
		\hline
		\cellcolor[HTML]{FFE0CC} Yolov11n & \cellcolor[HTML]{E6F2E6} 0.73618 & \cellcolor[HTML]{E6F2E6} 0.32413 & \cellcolor[HTML]{E6F2E6} 0.75859 & \cellcolor[HTML]{E6F2E6} 0.67134 & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- \\
		\hline
		\cellcolor[HTML]{FFE0CC} Yolov11m & \cellcolor[HTML]{E6F2E6} 0.75385 & \cellcolor[HTML]{E6F2E6} 0.33542 & \cellcolor[HTML]{E6F2E6} 0.77558 & \cellcolor[HTML]{E6F2E6} 0.68282 & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- \\
		\hline
		\cellcolor[HTML]{FFE0CC} Detectron2 & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} 0.773 & \cellcolor[HTML]{E6F2E6} 0.662 & \cellcolor[HTML]{E6F2E6} 0.713 & \cellcolor[HTML]{E6F2E6} 0.946 & \cellcolor[HTML]{E6F2E6} 0.091 & \cellcolor[HTML]{E6F2E6} 0.072 \\
		\hline
	\end{tabular}
\gr 
...
\paragraph{\textnormal{
\gr Αναλύοντας τα αποτελέσματα για όλα τα μοντέλα (\en \textbf{Yolov8n, Yolov11n, Yolov11m, Detectron2}) \gr στο \en \textbf{Fold 3}, \gr προκύπτει ο παρακάτω Πίνακας 6.5.
}}
{\scriptsize
\begin{center}
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|}
		...
		\cellcolor[HTML]{CCE5E5} \textbf{False Pos} \\
		\hline
		\cellcolor[HTML]{FFE0CC} Yolov8n & \cellcolor[HTML]{E6F2E6} 0.76740 & \cellcolor[HTML]{E6F2E6} 0.33519 & \cellcolor[HTML]{E6F2E6} 0.80039 & \cellcolor[HTML]{E6F2E6} 0.68953 & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- \\
		\hline
		\cellcolor[HTML]{FFE0CC} Yolov11n & \cellcolor[HTML]{E6F2E6} 0.76503 & \cellcolor[HTML]{E6F2E6} 0.33784 & \cellcolor[HTML]{E6F2E6} 0.77764 & \cellcolor[HTML]{E6F2E6} 0.69915 & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- \\
		\hline
		\cellcolor[HTML]{FFE0CC} Yolov11m & \cellcolor[HTML]{E6F2E6} 0.76395 & \cellcolor[HTML]{E6F2E6} 0.33601 & \cellcolor[HTML]{E6F2E6} 0.78212 & \cellcolor[HTML]{E6F2E6} 0.69812 & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- \\
		\hline
		\cellcolor[HTML]{FFE0CC} Detectron2 & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} -- & \cellcolor[HTML]{E6F2E6} 0.818 & \cellcolor[HTML]{E6F2E6} 0.701 & \cellcolor[HTML]{E6F2E6} 0.755 & \cellcolor[HTML]{E6F2E6} 0.955 & \cellcolor[HTML]{E6F2E6} 0.072 & \cellcolor[HTML]{E6F2E6} 0.068 \\
		\hline
	\end{tabular}
	\gr 
...
\paragraph{\textnormal{
\gr Παρατηρείται ότι το \en \textbf{Detectron2} \gr εμφανίζει το υψηλότερο \en \textbf{precision} (0.818), \en \textbf{recall} (0.701) \gr και \en \textbf{f1-score} (0.755), \gr υπερβαίνοντας τα μοντέλα \en \textbf{YOLO} \gr σε όλες τις βασικές μετρικές ταξινόμησης. \gr Παρόλο που δεν παρέχει \en \textbf{mAP} \gr μετρικές, η συνολική του απόδοση είναι ανώτερη σε αυτό το \en \textbf{fold}. \gr Επομένως, το \en \textbf{Detectron2} \gr αποτελεί την πιο αξιόπιστη επιλογή για το \en \textbf{Fold 3}.
}}
\paragraph{\textnormal{
\gr Συμπερασματικά, το \en \textbf{Detectron2} \gr είναι το καλύτερο μοντέλο για το \en \textbf{Fold 3}, \gr καθώς υπερέχει στις βασικές μετρικές \en precision, recall \gr και \en f1-score, \gr παρότι δεν υπολογίζει mAP.
}}
